...
class FlowStats(object):
    ...
    def get_angle_difference(self):
        ...
        original_spatial_shape = self.pred.shape[:-1]
        angles = angles.reshape(original_spatial_shape)
    ...
    def get_fl_score(self, pix=3, perc=5, per_img=False):
        ...
        original_spatial_shape = self.true.shape[:-1]
        size_true = size_true.reshape(original_spatial_shape)
